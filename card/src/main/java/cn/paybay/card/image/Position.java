...
public interface Position {
	 ...
	 *            The width of the enclosing object that is to contain the
	 *            enclosed object.
	 * @param enclosingHeight
	 *            The height of the enclosing object that is to contain the
	 *            enclosed object.
	 * @param width
	 *            The width of the object that is to be placed inside an
	 *            enclosing object.
	 * @param height
	 *            The height of the object that is to be placed inside an
	 *            enclosing object.
	 * @param insetLeft
